...
<body>
    ...
    <div class="row mt-4 mx-3 mx-lg-5 pe-lg-5">
        ...
        <section class="col-12 col-lg-9 pe-5">
            ...
            <div class="display-5 mb-4"> Latest Blog Post</div>
            <div class="blog-post-list">

                @foreach ($posts as $post)
                <div class="card my-5">
                    {{-- <img class="card-img-top" src="https://buildsterapp.com/wp-content/uploads/2020/08/dummy-images-1920x1280-4.png" alt=""> --}}
